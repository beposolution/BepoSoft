...
const AllAddTeamMembers = () => {
    ...
    const handleDeleteMember = async (memberId, memberName = "") => {
        const confirmDelete = window.confirm(
            `Are you sure you want to delete ${memberName || "this member"} from the sales team?`
        );
        ...
        try {
            ...
            const message =
                ...
                error?.message ||
                "Failed to delete sales team member";
                                                                                ...
                                                                                <td>
                                                                                    <div className="d-flex gap-2 flex-wrap">
                                                                                        <Button
                                                                                            color="info"
                                                                                            size="sm"
                                                                                            onClick={() => handleViewMember(item.id)}
                                                                                            disabled={
                                                                                        ...
                                                                                        <Button
                                                                                            ...
                                                                                            size="sm"
                                                                                            onClick={() =>
                                                                                                handleDeleteMember(item.id, item.user_name)
                                                                                            }
                                                                                            disabled={
                                                                                                deleteLoadingId === item.id ||
                                                                                                viewLoadingId === item.id
