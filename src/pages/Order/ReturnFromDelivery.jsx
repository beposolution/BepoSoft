...
const ReturnFromDelivery = () => {
    ...
    const status = "Return From Delivery";
                ...
                <div className="container-fluid">
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card>
                                <CardBody>
                                    <CardTitle className="h4">RETURN FROM DELIVERY (RFD) ORDERS</CardTitle>
...
export default ReturnFromDelivery;
